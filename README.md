...
- **Educator guide (live):** a full PD guide for K-12 and higher-ed instructors (lesson cards, debrief prompts, standards crosswalk, an AI-literacy bridge, and a data/assessment walkthrough) is hosted at **https://cipherfell.pages.dev/docs/guide** (source: [docs/EDUCATOR_GUIDE.md](docs/EDUCATOR_GUIDE.md)), with a ready-to-present **[facilitator slide deck](https://cipherfell.pages.dev/docs/facilitator_deck)**. Educator hub: **https://cipherfell.pages.dev/docs/**
