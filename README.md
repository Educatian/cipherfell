...
- **Educator guide:** a full PD guide for K-12 and higher-ed instructors (lesson cards, debrief prompts, standards crosswalk, an AI-literacy bridge, and a data/assessment walkthrough) is in **[docs/EDUCATOR_GUIDE.md](docs/EDUCATOR_GUIDE.md)**, with a ready-to-present **[facilitator slide deck](docs/facilitator_deck.html)**.
